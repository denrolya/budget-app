...
export const randomColor = () =>
  `rgba(${randomInt(0, 255)}, ${randomInt(0, 255)}, ${randomInt(0, 255)}, ${randomFloat(0, 1)})`;
...
export const arrowIcon = (p, isInverted = false) =>
  !isInverted
    ? {
      'ion-ios-arrow-round-down': p < 100,
      'ion-ios-arrow-round-up': p > 100,
    }
    : {
      'ion-ios-arrow-round-down': p > 100,
      'ion-ios-arrow-round-up': p < 100,
...
export const amountInPercentage = (total, amount, fractionDigits = 2) =>
  total > 0 ? Number(((100 * amount) / total).toFixed(fractionDigits)) : false;
...
export const confirmAccountArchivation = (account) =>
  Swal.fire({
...
export const confirmAccountRestoration = (account) =>
  Swal.fire({
...
export const confirmAccountNameChange = (account, newName) =>
  Swal.fire({
