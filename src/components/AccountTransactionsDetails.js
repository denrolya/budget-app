...
const AccountTransactionsDetails = ({ account }) => {
  const { name, numberOfTransactions, lastTransactionAt, latestTransactions, logs } = account;
        ...
        <Row>
            ...
            <Row className="mb-3">
              <Col xs={4} className="d-flex flex-column justify-content-between">
                ...
                <span className="h1 mb-4 font-weight-light">
                  ...
                  {daysFromLastTransaction}d <span style={{ fontSize: 15 }}>ago</span>
                </span>
              </Col>
              <Col xs={4} className="d-flex flex-column justify-content-between">
          ...
          <Col xs={12} md={6}>
            ...
            <p className="text-center py-3">
              <Button color="link">
                <Link to={generateLinkToAccountTransactionsPage(name)}>See all Transactions {'>'}</Link>
              </Button>
            </p>
          </Col>
        </Row>
